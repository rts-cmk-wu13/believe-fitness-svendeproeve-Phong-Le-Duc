...
const initialState = {
    ...
    assetId: null,
    // måske er det bare asset istedet for assetId
};
...
export default function FormCreateClass() {
    ...
    return (
        <form action="" className="flex flex-col gap-4 p-4 rounded-3xl max-w-md mx-auto mt-8 bg-white">
            <div>
            ...
            <div className="w-1/2">
                ...
                <input type="text" name="classTrainer" id="classTrainer" Value="Trainername" placeholder="Class trainer" className="p-2 rounded-full border border-gray-400 placeholder:text-sm placeholder:text-gray-400 placeholder:pl-2" required />
                <span className=" text-red-500 text-xs pl-2 mt-1 min-h-[1.5em]">{state && state.classTrainer?.errors?.[0]}</span>
            </div>
            ...
            <div>
                <label className="pl-2 -mb-4" htmlFor="assetId">Choose an image (assetId)</label>
                <input type="file" name="assetId" id="assetId" accept="image/png, image/jpeg, image/jpg" placeholder="Asset ID" className="p-2 rounded-full border border-gray-400 placeholder:text-sm placeholder:text-gray-400 placeholder:pl-2" />
